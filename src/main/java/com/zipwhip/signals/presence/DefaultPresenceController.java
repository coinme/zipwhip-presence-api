...
public class DefaultPresenceController implements PresenceController {
	...
	private JsonMessageSerializerFactory serializer = new JsonMessageSerializerFactory();
	...
	public void disconnect(ClientAddress clientAddress, InetSocketAddress reconnect, Integer delay) {
		...
		if (delay != null) {
			disconnectCommand.setReconnectDelay(delay.intValue());
		}
	...
	public final SimpleQueueSender getSimpleQueueSender()
	{
		return simpleQueueSender;
	}

	public final void setSimpleQueueSender(SimpleQueueSender simpleQueueSender)
	{
